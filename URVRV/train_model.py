...
'''
    Apparently: "Unlike Cross-Entropy Loss, which works at the pixel level, Dice Loss focuses on region-based optimization."
...
def main():
    ...
    #Load state and resume if specified
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        #Run validation after every epoch, so we can stop training early if there is no improvemenet for some time,,,
